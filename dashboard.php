...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <div class="sidenav-header">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active p-2 " href="../pages/dashboard.php">
        ...
        <li class="nav-item">
          <a class="nav-link " href="../pages/sign-in.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-sign-in-alt text-info text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Login</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="../pages/registrasi.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h2 class="font-weight-bolder text-white mb-0">Yayasan Darul Muhtar</h2>
        </nav>
      </div>
    </nav>
    <!-- End Navbar -->
...
<br>
  ...
  <!-- END Kegiatan Rutin -->
     ...
     <!--Prestasi -->
        <div class="col-6 w3-animate-right">
          <div class="card mb-4" style="height:500px">
            <div class="card-header pb-0">
              <h6>Prestasi</h6>
            </div>
