  ...
  <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <a href="tambahrutin.php"  class="search btn btn-primary" style="border-radius: 5px;"> 
        ...
        <td><?= $row["minggu"]; ?> </td>
        <td>
           <a href="editrutin.php?id_rutin=<?= $row["id_rutin"];  ?>" class="text-secondary font-weight-bold text-xs" >
           <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
           <i class="fas fa-edit text-info text-sm opacity-10"></i>
                </div> </a>
           <a href="hapusrutin.php?id_rutin=<?= $row["id_rutin"];  ?>"  class="text-secondary font-weight-bold text-xs"  onclick="return confirm ('Setuju?');">
           <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
