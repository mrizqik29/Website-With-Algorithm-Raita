          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              ...
              <input type="hidden" name="iduser" value ="<?= $user["iduser"]; ?>">
                ...
                <div class="mb-3">
                <input type="hidden" name="surat1lama" value ="<?= $user["surat1"]; ?>">
                <label for="namauser">  Surat Permohonan Pengangkatan Anak </label><br>
                <?php echo "<img src='../pages/syarat/$user[surat1]' width='80'/>";?><br>
                <input type="file" name="surat1" id="surat1">
                </div>
                <div class="mb-3">
                <label for="namauser">  KTP </label><br>
                <input type="hidden" name="surat2lama" value ="<?= $user["surat2"]; ?>">
                <?php echo "<img src='../pages/syarat/$user[surat2]' width='80'/>";?><br>
                <input type="file" name="surat2" id="surat2">
                </div>
                <div class="mb-3">
                <label for="namauser">  Kartu Keluarga </label><br>
                <input type="hidden" name="surat3lama" value ="<?= $user["surat3"]; ?>">
                <?php echo "<img src='../pages/syarat/$user[surat3]' width='80'/>";?><br>
                <input type="file" name="surat3" id="surat3">
                </div>
