...
$peserta = query("SELECT * FROM lomba WHERE idlomba = $id")[0];
$namaanak = query("SELECT nama, id FROM anakyatim");
        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
              <input type="hidden" name="idlomba" value ="<?= $peserta["idlomba"]; ?>">
        </div>
                <div class="mb-3">
                <label for="senin"> Nama Prestasi  </label>
                <input type="text" name="namalomba" id="namalomba"  class="form-control"required value="<?= $peserta ["namalomba"]; ?>">
                </div>

                <div class="mb-3 form-group">
                <label for="anak"> Anak Yatim Berprestasi </label>
                  <select type="text" name="namaanak" id="namaanak" class="form-control" required >
                <option>-</option>
                <?php foreach ($namaanak as $row):    
               ?>
