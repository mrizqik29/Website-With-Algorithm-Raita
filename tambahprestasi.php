...
$peserta = query("SELECT nama, id FROM anakyatim");


if (isset ($_POST["submit"])) {
  
     if( tambahprestasi($_POST) > 0 && updateanak($_POST) > 0){
         echo     "
          <script>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="navbar-nav mx-auto">
          <li class="nav-item">
            <a class="nav-link d-flex align-items-center me-2 active" aria-current="page" href="../pages/prestasi.php">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">Tambah Prestasi</h1>
            <p class="text-lead text-white">Masukkan Lomba dan Anak Yatim yang berprestasi</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              ...
              <form action="" method="post" enctype="multipart/form-data" >
                ...
                <div class="mb-3">
                <label for="lomba"> Prestasi yang didapat</label>
                  <input type="text" name="lomba" id="lomba" class="form-control" placeholder="Prestasi" required >
                </div>
              
             
               
                <div class="mb-3 form-group">
                <label for="anak"> Anak Yatim Berprestasi </label>
                  <select type="text" name="anak" id="anak" class="form-control" required >
                <option>-</option>
