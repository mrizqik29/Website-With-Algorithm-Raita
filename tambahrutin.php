      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Masukkan Kegiatan Rutin</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card-body">
              <form action="" method="post" enctype="multipart/form-data" >
                ...
                <label for="senin"> Senin</label>
                  <input type="text" name="senin" id="senin" class="form-control" placeholder="Kegiatan" required >
                </div>
                <div class="mb-3">
                <label for="selasa"> Selasa</label>
                  <input type="text" name="selasa" id="selasa" class="form-control" placeholder="Kegiatan" required >
                </div>
                <div class="mb-3">
                <label for="rabu"> Rabu</label>
                  <input type="text" name="rabu" id="rabu" class="form-control" placeholder="Kegiatan" required >
                </div>
                <div class="mb-3">
                <label for="kamis"> Kamis</label>
                  <input type="text" name="kamis" id="kamis" class="form-control" placeholder="Kegiatan" required >
                </div>
                <div class="mb-3">
                <label for="jumat"> Jum'at</label>
                  <input type="text" name="jumat" id="jumat" class="form-control" placeholder="Kegiatan" required >
                </div>
                <div class="mb-3">
                <label for="sabtu"> Sabtu</label>
                  <input type="text" name="sabtu" id="sabtu" class="form-control" placeholder="Kegiatan" required >
                </div>
                <div class="mb-3">
                <label for="minggu"> Minggu</label>
                  <input type="text" name="minggu" id="minggu" class="form-control" placeholder="Kegiatan" required >
                </div>
