...
$peserta = query ("SELECT idevent, namaevent, tanggalevent FROM kegiatanyayasan");
      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <a href="tambahkegiatanevent.php"  class="search btn btn-primary" style="border-radius: 5px;"> 
            Tambah Kegiatan Yayasan
           </a>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Kegiatan Yayasan</th>
        ...
        <td><?php echo  date('d-m-Y', strtotime($row ["tanggalevent"])); ?></td>
           <td>
           <a href="editkegiatanevent.php?idevent=<?= $row["idevent"];  ?>" class="text-secondary font-weight-bold text-xs" >
           <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
           <i class="fas fa-edit text-info text-sm opacity-10"></i>
                </div> </a>
           <a href="hapuskegiatan.php?idevent=<?= $row["idevent"];  ?>"  class="text-secondary font-weight-bold text-xs"  onclick="return confirm ('Setuju?');">
           <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
