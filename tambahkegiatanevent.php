      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">Tambah Kegiatan Yayasan</h1>
            <p class="text-lead text-white">Masukkan Kegiatan Yayasan</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form action="" method="post" enctype="multipart/form-data" >
                <div class="mb-3">
                <label for="eventyayasan"> Kegiatan Yayasan</label>
                  <input type="text" name="eventyayasan" id="eventyayasan" class="form-control" placeholder="Kegiatan Yayasan" required >
                </div>
                <div class="mb-3">
                <label for="tanggalkegiatan"> Tanggal Kegiatan</label>
                  <input type="date" name="tanggalkegiatan" id="tanggalkegiatan" class="form-control" placeholder="Tahun-Bulan-Hari" required >
                </div>
